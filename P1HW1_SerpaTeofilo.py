...
print()
print()
calculation = print(base_value, "raised to the power of", exponent, "is", base_value**exponent)
print()
print()
...
print()
print()
print(starting_int,"+",add,"-",subtract,"is equal to", starting_int+add-subtract)
